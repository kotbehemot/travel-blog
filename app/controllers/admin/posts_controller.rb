class Admin::PostsController < Admin::BaseController
  ...
  private
    ...
    def permitted_params
      params.require(:post).permit(:title, :content, :summary, :published, :published_at, :published_by, :place_id, :header_image, :footer_image, :video_link, :inverted_title, :photostory, :s_letter, :tag_list => [])
    end
end
